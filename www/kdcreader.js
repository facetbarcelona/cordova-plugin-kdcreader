...
var kreader = {
     ...
     * If the specific device is not provided, KDCReader will attempt to connect to all possible devices.
     *
     * @param {resultCallback} success callback when connection request is accepted.
     * @param {resultCallback} error callback when error occured.
     ...
     * 
     * @param {returnCallback} timeout barcode read timeout to be set. [100, 10000]
     * @param {resultCallback} success callback when successful.
     * @param {resultCallback} error callback when failed.
     */      
